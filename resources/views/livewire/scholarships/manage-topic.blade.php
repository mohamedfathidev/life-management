...
>
    ...
    <div x-show="open" x-transition class="relative w-full max-w-lg rounded-2xl bg-surface-light dark:bg-surface-dark shadow-xl p-6 max-h-[90vh] overflow-y-auto">
        ...
        <form wire:submit="save" class="space-y-4">
            <div>
                <x-input-label for="sct_title" value="العنوان" />
                <x-text-input id="sct_title" wire:model="form.title" type="text" class="mt-1 block w-full" placeholder="مثال: كيف تكتب خطاب تحفيز قوي" />
            ...
            <div>
                ...
                <div wire:ignore class="mt-1"
                    ...
                    <input id="sct_content_input" type="hidden">
                    <trix-editor x-ref="trix" input="sct_content_input" placeholder="اكتب النقاط والنصائح…" class="trix-content"></trix-editor>
                </div>
            </div>

            <div>
                <x-input-label for="sct_tags" value="الوسوم (بفاصلة)" />
                <x-text-input id="sct_tags" wire:model="form.tagsInput" type="text" class="mt-1 block w-full" placeholder="خطاب تحفيز، توصية، CV" />
            </div>
